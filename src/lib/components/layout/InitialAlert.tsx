...
export default function InitialAlert() {
  ...
  return isClient ? (
    <AlertDialog  open={shouldEmitAlert}>
      ...
      <AlertDialogContent className="scroll bg-[rgba(255,255,255,0.1)] dark:bg-[rgba(0,0,0,0.1)] backdrop-blur-2xl max-h-[100vh]   space-y-0   text-center sm:min-h-[452px] sm:min-w-[35vw] ">
